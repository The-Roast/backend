...
SECTION_PROMPT = dedent('''\
    ...
    procedure create_section(list_of_articles: List[String]):
        ...
        for-each String article_to_summarize in list_of_articles:
            ...
            summary_with_citation = {After generating the summary_with_personality you MUST add the token "[CITATION]" at the text of summary_with_personality. This MUST be done for each article_to_summarize as it provides clarity and transparency to the end user. If you do not do this, you will fail at your task as outlined. As a reminder, you MUST add the token "[CITATION]" to the end of summary_with_personality for each article_to_summarize to effectively complete your task.}
            ...
            body = body + <b>hook</b> + summary_with_citation + "\n\n"
        json["body"] = body
        return json
    ''')
